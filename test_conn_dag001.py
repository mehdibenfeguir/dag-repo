...
es_host = os.getenv('CREDENTIALS_ELASTICSEARCH_PROXY_HOST', 'amundsen-elasticsearch-master')
...
def connection_string():
    connection = BaseHook.get_connection('Test001') 
...
with DAG('amundsen_databuilder_test001', default_args=default_args, **dag_args) as dag:
